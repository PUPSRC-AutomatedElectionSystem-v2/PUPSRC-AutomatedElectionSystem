...
<label class="switch d-none" id="switch">
  ...
  <span class="slider round"></span>
    ...
    <div class="col-lg-4 ml-5 py-3 ps-0 pe-1 ">
        <div class="col-lg-11">
            <a href="result-generation.php" class="card admin-card admin-link px-5 pt-4 pb-5 shadow-sm">
    ...
    <div class="col-lg-4 ml-5 py-3 ps-0 pe-1 d-lg-flex d-md-block justify-content-center ">
        <div class="col-lg-11">
            <a href="manage-voters.php" class="card admin-card admin-link px-5 pt-4 pb-5 shadow-sm">
                <div class="card-body d-flex align-items-center justify-content-center p-2">
                    <div class="icon-container">
    ...
    <div class="col-lg-4 ml-5 py-3 ps-0 pe-0 d-lg-flex d-md-block justify-content-end ">
        <div class="col-lg-11">
            <a href="configuration.php" class="card admin-card admin-link px-5 pt-4 pb-5 shadow-sm">
                <div class="card-body d-flex align-items-center justify-content-center p-2">
                    <div class="icon-container">
