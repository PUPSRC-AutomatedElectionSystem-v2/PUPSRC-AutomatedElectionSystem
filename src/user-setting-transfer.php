              ...
              <div class="py-3 px-2 px-lg-4 px-sm-1">
                ...
                <div id="section-1">
                  ...
                  <div class="d-flex justify-content-end">
                    <div class="main-color pt-2"><a href="user-setting-transfer?page=2" class="custom-link"> <b>Proceed</b> &nbsp;
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content d-flex align-items-center justify-content-center" style="border-radius: 20px;" id="success-modal">
                    <div class="modal-body text-center w-100 mt-4 mb-2">
                        ...
                        <button type="button" class="btn btn-gray" id="cancelModalButton"><a href="user-setting-transfer" class="custom-link"><b>Cancel</b></a></button>
...
<?php
    ...
    header("Location: user-setting-information");
  }
} else {
