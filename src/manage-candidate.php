...
?>
	...
	<body>
							...
							<div class="align-items-end ms-auto me-4 mx-a">
								<a href="add-candidate.php">
									<button type="button" class="button-add rounded-2 fs-7">
										...
										<span class="button-text">Add New Candidates</span>
									</button>
								</a>
							</div>
						</div>
											...
											<div class="table-wrapper">
												<div class="table-title">
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="row">
																<div class="col-md-12 filters-sort text-end flex-end">
																	<!-- Delete -->
																	<div class="d-inline-block ">
																		<button class="delete-btn admin-delete-btn fs-7 spacing-6 fw-medium" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																		...
																		<form id="filterForm" class="d-inline-block">
																			<div class="dropdown sort-by">
																				<button class="sortby-tbn fs-7 spacing-6 fw-medium" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																					<i data-feather="filter" class="feather-xs im-cust-2"></i>
																					Filter
																				</button>
																				<div class="dropdown-menu dropdown-menu-end" id = "filterMenu"aria-labelledby="dropdownMenuButton" style="padding: 0.5rem">
																			...
																			<div class="dropdown sort-by">
																				...
																				<div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="padding: 0.5rem">
																					...
																					<li class="dropdown-item ps-3 fs-7 fw-medium">
																						<a href="#" data-sort="acc_created" data-order="desc" class="sort-link">Newest to
																							Oldest</a>
																					</li>
																					<li class="dropdown-item ps-3 fs-7 fw-medium">
																						<a href="#" data-sort="acc_created" data-order="asc" class="sort-link">Oldest to
																							Newest</a>
																					</li>
																					<li class="dropdown-item ps-3 fs-7 fw-medium">
																						<a href="#" data-sort="first_name" data-order="asc" class="sort-link">A to Z
																							(Ascending)</a>
																					</li>
																					<li class="dropdown-item ps-3 fs-7 fw-medium">
																						<a href="#" data-sort="first_name" data-order="desc" class="sort-link">Z to A
																							(Descending)</a>
																					</li>
																				</div>
																			</div>
																	...
																	<div class="search-container">
																		<input class="search-input fs-7 spacing-6 fw-medium" type="text" placeholder="    Search..." id="searchInput">
																	</div>
																</div>
															</div>
														</div>
													...
													<?php if ($verified_tbl->num_rows > 0) { ?>
														...
														<table class="table" id="adminTable">
															<thead class="tl-header">
																<tr>
																	<th class="col-md-3 tl-left d-none checkbox-all-admin text-center">
																	...
																	<th class="col-md-3 text-center fs-7 fw-bold spacing-5">
																		<i data-feather="star" class="feather-xs im-cust"></i>Candidate Position
																	</th>
															...
															<tbody>
																<?php while ($row = $verified_tbl->fetch_assoc()) { ?>
																	<!-- Generated in manage-candidate.js -->
																<?php } ?>
															</tbody>
														</table>
														...
														<div class="clearfix col-xs-12">
															<ul class="pagination" id="candidatePagination">
																<!-- Verification pagination will be generated here -->
															</ul>

															<div class="d-flex justify-content-start pt-2">
																<button id="deleteSelectedAdmin" class="btn btn-danger px-sm-4 py-sm-1-5 btn-sm fw-bold fs-6 spacing-6 final-delete-btn-admin d-none rounded-3" type="button" disabled>Delete
																	Selected</button>
																<button class="btn btn-light btn-cancel px-sm-4 py-sm-1-5 btn-sm fw-bold fs-6 spacing-6 rounded-3 cancel-admin d-none">Cancel</button>
															</div>
														</div>
													...
													<?php } else { ?>
														...
														<div class="table-title">
															<table class="table" id="adminTable">
																<thead class="tl-header">
																	<tr>
																		<th class="col-md-4 tl-left text-center fs-7 fw-bold spacing-5">
																			<i data-feather="user" class="feather-xs im-cust"></i>Full Name
																		</th>
					...
					<div class="modal-body">
						...
						<div class="row p-4">
							...
							<div class="col-md-12 pt-1 text-center">
								<div class="d-inline-block">
									<button class="btn btn-light px-sm-5 py-sm-1-5 btn-sm fw-bold fs-6 spacing-6" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
								</div>
								<div class="d-inline-block">
									<form class="d-inline-block">
										<input type="hidden" id="candidate_id" name="candidate_id" value="">
										<button class="btn btn-danger px-sm-5 py-sm-1-5 btn-sm fw-bold fs-6 spacing-6" type="button" id="confirm-move" value="delete">Delete</button>
									</form>
								</div>
							</div>
		...
		<script src="scripts/manage-candidate.js"></script>
