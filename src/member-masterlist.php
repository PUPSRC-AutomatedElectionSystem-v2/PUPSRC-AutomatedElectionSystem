        ...
        <div class="container account-container" id="memMasterList">
            <div class="row justify-content-center">
                ...
                <div class="col-12">
                    ...
                    <div class="mt-3">
                        <a href="voter-login.php" class="spacing-5 link-offset-1 fw-semibold text-muted nav-back"><i data-feather="arrow-left" class="feather-sm im-cust"></i><u>Go back to login page</u></a>                        
                    </div>
