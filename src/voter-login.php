            ...
            <div class="col-md-6 col-xs-12 login-right-section">
                ...
                <div>
                    <form id="loginForm" action="includes/voter-login-inc.php" method="post" class="login-form needs-validation" novalidate>
                        ...
                        <p class="sign-up-redirect fw-medium">Don't have an account? <a href="register" id="<?php echo strtolower($org_name); ?>SignUP" class="sign-up">Sign Up</a></p>
                        
                        <?php if($_SESSION['organization'] !== 'sco') : ?>
                            <p class="acc-list-link lh-sm fw-medium pt-3">If you're an eligible member of <?php echo htmlspecialchars(strtoupper($org_acronym)); ?>, <br/>you can set up your account <a href="member-masterlist" class="fw-bold main-color">here.</a></p>
                        <?php endif; ?>
