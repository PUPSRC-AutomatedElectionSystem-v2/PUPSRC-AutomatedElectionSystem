...
<link rel="stylesheet" href="src/styles/config-registration-schedule.css?v=2">
    ...
    <div class="container px-md-3 px-lg-5 px-sm-2">
        ...
        <section class="schedule card-box" data-state="view">
            <div class="content col-12 col-sm-10 col-md-9">
                <div class="subtitle">
                    Select a starting and ending date and time for the registration period.
                </div>
...
<section class="modals-container">
    ...
    <?php
    Modals::getSuccessModal("Schedule set successfully", 'The date and time of registration for this election year have been successfully set.');
    ?>
...
$page_scripts = '
<script type="module" src="src/scripts/config-registration-schedule.js?v=2"></script>
