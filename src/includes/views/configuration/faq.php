            ...
            <div class="modal-content">
                <div class="modal-header editor">
                    <h5 class="modal-title">
                        <span class="edit">Frequently Asked Question #</span>
                        <span class="add d-none">
                            Add New Question
                        </span>
                        <span class="guideline-num"></span>
                    </h5>
...
<script  type="module" src="src/scripts/config-faq.js?v=2"></script>
