 ...
 * @route '//pupsr-aes.test/dashboard'
 */
 ...
 * @route '//pupsr-aes.test/settings/appearance'
 */
...
appearance.definition = {
    methods: ["get", "head"],
    url: '//pupsr-aes.test/settings/appearance',
} satisfies RouteDefinition<["get", "head"]>
