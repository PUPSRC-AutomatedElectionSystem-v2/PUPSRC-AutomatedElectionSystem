    ...
    ->withRouting(
        ...
        using: function () {
            ...
            Route::middleware(['api', 'tenant'])
                ...
                ->prefix('org/api')
                ->group([
                    base_path('app-modules/organization-admin/routes/api/api.php'),
                    // base_path('app-modules/tenant-auth/routes/api/api.php'),
                    // base_path('app-modules/organization-voting/routes/api/api.php'),
                ]);
        }
    )
