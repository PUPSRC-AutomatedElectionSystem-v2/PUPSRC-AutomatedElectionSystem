...
if (isset($_SESSION['voter_id']) && ($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'head_admin')) {
    ...
    include FileUtils::normalizeFilePath('submission_handlers/recycle-bin-admin.php');
                        ...
                        <table class="table">
                            <thead class="tl-header">
                                <tr>
                                    ...
                                    <th class="col-md-3 text-center fs-7 fw-bold spacing-5">
                                        <i data-feather="star" class="feather-xs im-cust"></i> Committee Role
                                    </th>
                                ...
                                <?php while ($row = $verified_tbl->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td class="col-md-6 text-center text-truncate">
                                            <?php
                                            if ($row['role'] == 'admin') {
                                                echo '<span class="badge rounded-pill badge-admin badge-lg px-4">Admin</span>';
                                            } elseif ($row['role'] == 'head_admin') {
                                                echo '<span class="badge rounded-pill badge-head badge-lg">Head Admin</span>';
                                            } else {
                                                // Handle other roles if needed
                                                echo $row['role']; // Display the role normally if it doesn't match admin or head_admin
                                            }
                                            ?>
                                        </td>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-7 pe-5">
                                <b>
                                    <p id="modal-name" class="spacing-6 m-0 ps-4"> </p>
                                </b>
